...
GoPxL® 是 LMI Technologies 推出的一款新一代 IIoT 视觉检测软件平台，用于创建端到端、基于 Web 的在线测量与检测解决方案，可部署在 Gocator® 3D 智能传感器和 Gocator® 2D 智能相机上，并支持在 GoMax® 或 PC 上运行。

视觉工程师可使用 GoPxL® 完成广泛的工业检测任务，通过结合运行在 Gocator 业界领先视觉硬件上的设备端测量滤波器和检测工具，实现高效、可靠的在线检测解决方案。
...
-   [:material-monitor-dashboard:{ .lg .middle } __定制化 HMI__](../images/gopxl_introduction/web_ui_demo.png){: .glightbox }
    ---
